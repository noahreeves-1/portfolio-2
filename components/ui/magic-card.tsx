...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      className={cn(
        "group relative isolate overflow-hidden rounded-[inherit] border border-oklch(0.92 0.004 286.32) border-transparent dark:border-oklch(1 0 0 / 10%)",
        className
      )}
    ...
    >
      <div className="bg-oklch(1 0 0) absolute inset-px z-20 rounded-[inherit] dark:bg-oklch(0.141 0.005 285.823)" />
